...
func (user *User) CreateSession() (session Session, err error) {
	...
	err = Db.QueryRow("SELECT id, uuid, email, user_id, created_at FROM sessions WHERE id = ?", id).
...
func (user *User) Create() (err error) {
	...
	stmt.Exec(createUUID(), user.Name, user.Email, Encrypt(user.Password), time.Now())
	return
}
